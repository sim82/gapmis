...
void fill_txtsLenVec (unsigned int totalTxts, const char const ** in, int * outVec);
void fill_argsVec (unsigned int totalPats, unsigned int totalTxts, const char const ** in, unsigned int max_gap, unsigned int pBlockSize, unsigned int maxPatLen, unsigned int maxTxtLen, int * outVec);
void fill_patsVec (unsigned int total, unsigned int blockSize, const char const ** in, unsigned int * outVec, int matrix);
void fill_txtsVec (unsigned int total, unsigned int blockSize, const char const ** in, unsigned int * outVec, int matrix);
...
unsigned int kernel_launch (cl_kernel kernel, cl_context context, cl_command_queue cmd_queue, const char const ** p, const char const ** t, const struct gapmis_params * in, float * scores);
unsigned int kernel_launch_l (cl_kernel kernel, cl_context context, cl_command_queue cmd_queue, const char const ** p, const char const ** t, const struct gapmis_params * in, float * scores, struct gapmis_align * out);
...
void initialize_pointers (const char * groupPatterns[], int groupIndex, int groupSize, const char const ** source, int sourceSize);
